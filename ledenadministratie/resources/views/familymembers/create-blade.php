        ...
        <form method="POST" action="/families" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="name"
                    placeholder="Voorbeeld: Skywalker" value="{{old('name')}}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="address"
                    placeholder="Voorbeeld: Zandweg 1, 2233GG, Utrecht" value="{{old('address')}}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="email"
                    placeholder="Voorbeeld: email@outlook.com" value="{{old('email')}}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="website"
                    placeholder="https://www.google.nl/" value="{{old('website')}}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="tags"
                    placeholder="Voorbeeld: Laravel, Zwemmen, OCR, etc" value="{{old('tags')}}" />
